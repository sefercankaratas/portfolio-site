...
function HistoryChart({ series, activeIdx, min, max }) {
  const w = 900, h = 220, padL = 60, padR = 20, padT = 20, padB = 36;
...
function PieChart({ data, size = 220, innerRadiusRatio = 0.62, centerLabel, maxLabeled = 10 }) {
  ...
  const pad = 92; // room for outside labels + leader lines
  ...
  const onlyLabelAbove = 0.02; // hide leader-line labels for slivers under 2% to reduce clutter; still shown in legend
