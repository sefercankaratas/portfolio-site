                  ...
                  <Panel title={prevMonth.display_name + ' → ' + month.display_name + ' — Nakit Akışı'}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      ...
                      <div style={{ fontSize: 11, color: '#576270', marginTop: 4 }}>
                        Adet/miktar artışı yeni yatırım, geri kalanı fiyat hareketinden sayılır. TEB Portföy Para Piyasası (nakit havuzu) buraya dahil değildir — oradan yapılan aktarımlar zaten kendi paranız olduğu için ne yeni para ne piyasa hareketi sayılır.
                      </div>
                    </div>
                  </Panel>
                );
